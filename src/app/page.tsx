...
import { Bookmark, CopyPlus, Ellipsis, FileText, GraduationCap, IdCard, Maximize, Play, Share, Shuffle, Star } from "lucide-react";
        ...
        <div className="flex flex-col min-h-screen w-full">
          ...
          <div className="mx-42 mt-8 flex flex-col gap-8">
            <div className="flex flex-row justify-center">
              <span className={cn("text-3xl font-light", currentQuestion == totalQuestions ? "hidden" : "block")}>{currentQuestion+1} | {totalQuestions}</span>
            </div>
